...
public class CFX_SpawnSystemEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if((UnityEngine.Event.current.type == EventType.DragPerform || UnityEngine.Event.current.type == EventType.DragUpdated)
			&& dropRect.Contains(UnityEngine.Event.current.mousePosition))
		{
